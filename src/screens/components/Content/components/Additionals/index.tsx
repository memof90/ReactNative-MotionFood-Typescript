...
export default function Additionals({ aditionals }: Props) {
  ...
  return (
    <S.Container>
      <S.Picture source={tomato} top={0} left={0} style={image1AnimatedStyle} />
      <S.Picture source={tomato} right={0} top={0} style={image2AnimatedStyle} />
      <S.Picture source={tomato} alignSelf="center" style={image3AnimatedStyle} />
      <S.Picture source={tomato} bottom={0} right={0} style={image4AnimatedStyle} />
      <S.Picture source={tomato} bottom={0} style={image5AnimatedStyle} />
    </S.Container>
  );
}
